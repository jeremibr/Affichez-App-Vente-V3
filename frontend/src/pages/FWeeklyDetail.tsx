    ...
    return (
        <div className="p-4 md:p-8 max-w-screen-2xl mx-auto space-y-6 md:space-y-8">
            <div className="flex items-start justify-between gap-4">
                <div>
                    <h1 className="text-xl md:text-2xl font-bold text-slate-900 tracking-tight">Factures — Détail Hebdo</h1>
                    <p className="text-xs md:text-sm text-slate-400 mt-0.5">Vue équipe complète</p>
                </div>
            </div>
            ...
            {loading ? (
                ...
                <div className="bg-white rounded-2xl border border-slate-100 shadow-card p-20 text-center">
                    ...
                    <p className="text-sm text-slate-400 mt-1">Aucune donnée disponible pour le moment.</p>
                </div>
            ) : (
                <div className="space-y-6">
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 md:gap-6">
                        ...
                        <div className="bg-white rounded-2xl p-3 md:p-6 border border-slate-100 shadow-card flex items-center justify-between group hover:border-brand-main/20 transition-all">
                            <div className="min-w-0">
                                ...
                                <p className="text-base md:text-2xl font-black text-slate-800 mt-1">{lineItems.length} <span className="text-xs md:text-base">Factures</span></p>
                            </div>
                    ...
                    <ZoneBTable lineItems={lineItems} module="factures" />
                </div>
            )}
        </div>
    );
